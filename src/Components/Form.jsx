...
const Form = () => {
  return (
    <div className="text-white">
      ...
      {/* Buttons Container */}
      <div id="btns" className="w-[50vw] max-sm:w-[90vw] mx-auto mt-4 flex flex-row justify-center gap-2 items-center font-semibold">
        <button className="bg-gray-900 w-full p-1.5 rounded-lg cursor-pointer hover:opacity-85 transition-all outline-none">Prev</button>
        <button className="bg-blue-500 w-full p-1.5 rounded-lg cursor-pointer hover:opacity-85 transition-all outline-none">Next</button>
      </div>
    </div>
  );
};
