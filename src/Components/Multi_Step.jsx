  ...
  const validForm = (counter) => {
    if (counter == 1) {
      if (!Form.name || !Form.dob || !Form.gender) {
        ...
        handleError.current.textContent = "Please fill the details!";
        return false;
      }
    }
    if (counter == 2) {
  ...
  return (
    <div className="text-white">
      ...
      >
        ...
        <div
          id="error"
          className="bg-red-800 py-1 mb-1.5 rounded-md font-semibold px-1.5 hidden"
          ref={handleError}
        ></div>
        {/* Form 1 */}
        <div ref={step1}>
